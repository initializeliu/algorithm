 ...
 * 但是每个玩家每次只能拿最左或最右的纸牌，玩家A和玩家B都绝顶聪明，请返回最后获胜者的分数。
 *
 * 举例
 * arr=[1,2,100,4]
 * 开始时，玩家A只能拿走1或4。如果开始时玩家A拿走1，则序列变为[2,100,4],接下来玩家B可以拿走2或4，然后继续轮到玩家A
 * 如果开始时玩家A拿走4，则排列变为[1,2,100],接下来玩家B可以拿走1或100，然后继续轮到玩家A。。。
 * 玩家A作为绝顶聪明的人不会先拿4，因为拿4之后，玩家B将100，所以玩家A会先拿1，让排列变为[2,100,4],接下来玩家B不管怎么选，
